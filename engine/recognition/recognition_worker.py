...
class RecognitionWorker:
    ...
    def _process_one(
        ...
        try:
            ...
            output: RecognitionOutput = self.provider.recognize(resolved_path)
            if output.series is None and not output.characters:
                self.statistics.increment_skipped()
            ...
            character_names = [label.name for label in output.characters]
